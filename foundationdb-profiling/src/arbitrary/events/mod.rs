//! Arbitrary implementation for events
//!
//! This module contains the Arbitrary implementation for events
...
impl ToBytesWithProtocolVersion for Event {
    /// Serializes the given `Event` into the given `writer` using the specified
    /// `protocol_version`.
    ///
    /// # Errors
    ///
...
impl ToBytesWithProtocolVersion for ProfilingEvent {
    /// Serializes a `ProfilingEvent` into the given `writer` using the specified
    /// `protocol_version`.
    ///
    /// # Errors
    ///
