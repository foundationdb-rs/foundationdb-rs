...
typedef enum {
    ...
    /* Parameter: Option takes no parameter */
    FDB_NET_OPTION_TLS_DISABLE_PLAINTEXT_CONNECTION=55,
...
typedef enum {
    ...
    /* Parameter: (String) A string identifier for the datacenter */
...
typedef enum {
    ...
    FDB_TR_OPTION_IDEMPOTENCY_ID=504,
    ...
    /* Parameter: (Bytes) A serialized binary byte string of length 33 used to associate the span of this transaction with a parent */
    ...
    FDB_TR_OPTION_AUTHORIZATION_TOKEN=2000,
    ...
    /* Parameter: Option takes no parameter */
    FDB_TR_OPTION_ENABLE_REPLICA_CONSISTENCY_CHECK=4000,
    ...
    FDB_TR_OPTION_CONSISTENCY_CHECK_REQUIRED_REPLICAS=4001
